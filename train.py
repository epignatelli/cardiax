...
if __name__ == "__main__":
    ...
    def main(argv):
        ...
        flags.DEFINE_string("--from_checkpoint", None, "")

        #  input data arguments
        flags.DEFINE_string("--root", "/home/epignatelli/data/train/", "")
        ...
        val_set = Paramset5Dataset(
            root=os.path.join(hparams.root, "val"),
            frames_in=hparams.frames_in,
            frames_out=n_sequence_out,
            step=hparams.step,
            batch_size=hparams.batch_size,
        ...
        for i in range(hparams.epochs):
            ...
            for j in enumerate(val_set.num_batches):
                ...
                j_val, ys_hat = saresnet.evaluate(
                    network, params, hparams.evaluation_steps, xs, ys
                )
