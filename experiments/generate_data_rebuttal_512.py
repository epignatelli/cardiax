...
#  setup
filename = "rebuttal/heterogeneous_linear_512_{}-{}.hdf5"
...
#  setup
filename = "rebuttal/heterogeneous_spiral_512_{}-{}.hdf5"
#  Finite difference simulation
stop = 100_000
p1 = cardiax.stimulus.Protocol(40_000 * 0, 2, 1e9)
...
#  setup
filename = "rebuttal/homogeneous_linear_512_{}-{}.hdf5"
#  Finite difference simulation
p1 = cardiax.stimulus.Protocol(40_000 * 0, 2, 1e9)
p2 = cardiax.stimulus.Protocol(40_000 * 1, 2, 1e9)
p3 = cardiax.stimulus.Protocol(40_000 * 2, 2, 1e9)
...
#  setup
filename = "rebuttal/homogeneous_spiral_512_{}-{}.hdf5"
#  Finite difference simulation
stop = 100_000
p1 = cardiax.stimulus.Protocol(40_000 * 0, 2, 1e9)
p2 = cardiax.stimulus.Protocol(40_000 * 0 + 40_000, 2, 1e9)
