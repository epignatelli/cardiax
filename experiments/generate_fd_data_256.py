...
if __name__ == "__main__":
    filename = "data/heterogeneous_spiral_256_{}-{}.hdf5"
    ...
    for seed in range(10):
        ...
        s2 = cardiax.stimulus.triangular(
            shape, cardiax.stimulus.Direction.NORTH, angle + 90, 0.5, 20, p2
        )
        stimuli = [s1, s2]
    ...
    filename = "data/heterogeneous_linear_256_{}-{}.hdf5"
    #  Finite difference simulation
    p1 = cardiax.stimulus.Protocol(0, 2, 1e9)
    ...
    filename = "data/homogeneous_spiral_256_{}-{}.hdf5"
    #  Finite difference simulation
    p1 = cardiax.stimulus.Protocol(0, 2, 1e9)
    p2 = cardiax.stimulus.Protocol(40_000, 2, 1e9)
    for seed in range(10):
    ...
    filename = "data/homogeneous_linear_256_{}-{}.hdf5"
    #  Finite difference simulation
    p1 = cardiax.stimulus.Protocol(0, 2, 1e9)
    p2 = cardiax.stimulus.Protocol(50_000, 2, 1e9)
    for seed in range(10):
