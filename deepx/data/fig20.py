...
protocol2 = fk.stimulus.protocol(start=fk.convert.ms_to_units(200, dt), duration=2, period=0)
s2 = fk.stimulus.rectangular(shape, jax.ops.index[fk.convert.cm_to_units(3, dx):], 1., protocol2)
